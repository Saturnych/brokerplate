...
export const isString = (s): boolean => (typeof s === 'string' || s instanceof String);

export const isObject = (o): boolean => (o !== null && typeof o === 'object' && !(o instanceof String));

export const isPlainObject = (o): boolean => (o != null
    ? Object.getPrototypeOf(o) === Object.prototype || Object.getPrototypeOf(o) === null
    : false);

export const isDate = (d): boolean => (d instanceof Date && !Number.isNaN(d.getTime()));

export const flatten = (arr) => Array.prototype.reduce.call(arr, (a, b) => a.concat(b), []);
...
export const getServices = async (broker: ServiceBroker, serviceName: string = ''): Promise<Record<string, Service | Service[] | unknown> | Error> => {
  try {
